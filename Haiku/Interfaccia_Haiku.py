...
finestra2= tk.Canvas(root, width = 300, height = 120, bg="#00ffa2")
finestra2.pack()
finestra.create_window(300,140, window=finestra2)

quinario= finestra2.create_text(150,30, font= ("georgia", 20))
settenario= finestra2.create_text(150,60, font= ("georgia", 20))
quinario2= finestra2.create_text(150,90, font= ("georgia", 20))
